...
- Owning slice: S06 (agent-side ✅ done; UI/voice/API — Lane B, pending)
...
- Owning slice: S05 — Lane B, not yet built (apps/api still hello-world scaffold)
...
- Owning slice: S07 — Lane B, not yet built (apps/web still hello-world scaffold)
...
- Owning slice: S08 — agent-side (run.bat + rotating log) ✅ done
...
- Owning slice: S08 — agent-side (demo-emitter + replay) ✅ done; UI toggle button — Lane B, pending
...
- Owning slice: S08 — Lane B, not yet built (dashboard seed data)
...
- Owning slice: S06 — Lane B, not yet built (pure UI, no agent-side piece)
...
- Owning slice: S06 — Lane B, not yet built (audio asset + API proxy, no agent-side piece)
...
- **Lane A (`apps/agent/`) — fully done:** S01, S02, S03, S04, and the agent-side pieces of S06 (R004's breathing guide) and S08 (R011 run.bat/log, R012 demo replay)
- **Lane B (`infra/`, `apps/api/`, `apps/web/`) — not yet built**, despite earlier tracking claiming otherwise: S05 (R006, R017, R022 — API is still a hello-world scaffold), S07 (R007, R008, R009, R019 — web is still a hello-world scaffold), the UI/voice/API halves of S06 (R004's UI+voice, R015, R023), and S08's R013 (seed data)
